...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ezcomptesMicroserviceApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ezcomptesMicroserviceApplication");
        ...
        config.getMapConfigs().put("com.girault.thomas.ezcomptes.domain.*", initializeDomainMapConfig(jHipsterProperties));
